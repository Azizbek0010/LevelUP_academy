...
export const TYPE_META = {
  sariq: { label: 'Жёлтое предупреждение', short: 'Сарық', color: '#eab308', dark: true },
  qizil: { label: 'Красное предупреждение', short: 'Қизил', color: '#dc2626' },
  qora: { label: 'Увольнение', short: 'Қора', color: '#111827' },
};
