          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-1">
                  <StatusBadge status={hsStatus} size="sm" label={hsStatus === 'active' ? 'Faol' : hsStatus === 'frozen' ? 'Muzlatilgan' : hsStatus} />
                </div>
              </div>
            </div>
          ...
          {filteredHw.map((h) => (
            <div key={h.id} className="p-4 rounded-[14px] border border-[var(--border)] bg-[var(--surface)] space-y-2">
              <div className="flex items-start justify-between gap-3">
                ...
                <StatusBadge status={h.status} label={statusLabel(h.status)} />
              </div>
