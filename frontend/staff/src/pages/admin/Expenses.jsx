                  ...
                  <tbody>
                    {filtered.map((e, idx) => (
                      <tr key={e.id}>
                        ...
                        <td className="text-right font-bold tabular-nums whitespace-nowrap text-[14px]">
                        ...
                        <td className="tabular-nums whitespace-nowrap text-[12px]">
                        ...
                        <td className="text-[var(--text-secondary)] text-[12px] hidden md:table-cell">
                          {getCreatedBy(e)}
                        </td>
                        <td>
                          <ActionDropdown
