          ...
          <div className="overflow-x-auto">
            <table className="table-premium">
              ...
              <tbody>
                {payments.map((p) => (
                  <tr key={p.id}>
                    <td className="font-semibold">{formatDate(p.date)}</td>
                    <td className="text-right font-bold tabular-nums">{formatMoney(p.amount)}</td>
                    <td>
                    ...
                    <td>
                      <StatusBadge status={p.status} label={PAYMENT_STATUS_LABELS[p.status] || p.status} />
                    </td>
                  </tr>
                ))}
              </tbody>
