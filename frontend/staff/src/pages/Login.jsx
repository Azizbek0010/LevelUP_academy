...
function LoginForm({ onForgot }) {
  ...
  return (
    <>
      ...
      <p className="text-sm opacity-60 mb-6 animate-slide-up stagger-1">Super Admin · Администратор · Branch Manager · Ментор · Методист</p>
    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-base-200">
      ...
      <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-sidebar text-neutral-content p-12">
        ...
        <div className="relative">
          ...
          <p className="opacity-60 mt-2 max-w-sm animate-slide-up stagger-1">Super Admin, Администратор, Branch Manager, Ментор и Методист — управляйте своей организацией из одной панели.</p>
