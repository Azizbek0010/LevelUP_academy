...
// разбить "Имя Фамилия" из заявки на два поля (грубо, но удобно)
...
export default function OnboardModal({ lead, onClose, onDone }) {
  ...
  const [done, setDone] = useState(null); // { tempPassword, superadmin }
        ...
        {done ? (
          <div className="space-y-3">
            ...
            <p className="text-sm opacity-70">
              ...
              Передайте партнёру доступ (пароль показывается один раз):
            </p>
